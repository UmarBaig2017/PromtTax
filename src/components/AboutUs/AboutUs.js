    ...
    render() {
        return (
            <div>
                ...
                <section class="hero-wrap hero-wrap-2" style={{ backgroundImage: `url(${background})` }}>
                    ...
                    <div class="container">
                        <div class="row justify-content-center mb-5 pb-2 d-flex">
                            <div class="col-md-6 align-items-stretch d-flex">
                                <div class="img img-video d-flex align-items-center" style={{ backgroundImage: `url(${about})` }} >
